...
describe('CharactersPages', () => {

    test('render CharactersPages component with default order and orderBy', () => {
        // when
    ...
    test('render CharactersPages component with order and orderBy from search params', async () => {
        // when
        const order = 'desc';
    ...
    test('render CharactersPages component with order and orderBy when the select changes', async () => {
        // when
        const order = 'desc';
        const orderBy = 'modified';
